...
public class LoginShippingPage {
    ...
    public WebElement getInputForStreetAddress(WebDriver driver) {
        streetAddress = driver.findElement(
                By.xpath(
                        "/html/body/div[3]/main/div/div/div/div[4]/ol/li[1]/div[2]/form/div/fieldset/div/div[1]/div/input"));
    ...
    public Select getDropDownForCountry(WebDriver driver) {
        country = new Select(
                driver.findElement(
                        By.xpath(
                                "/html/body/div[3]/main/div/div/div/div[4]/ol/li[1]/div[2]/form/div/div[4]/div/select")));
    ...
    public WebElement getInputForCity(WebDriver driver) {
        city = driver.findElement(
                By.xpath(
                        "/html/body/div[3]/main/div/div/div/div[4]/ol/li[1]/div[2]/form/div/div[7]/div/input"));
    ...
    public WebElement getInputForPostalCode(WebDriver driver) {
        postalCode = driver.findElement(
                By.xpath(
                        "/html/body/div[3]/main/div/div/div/div[4]/ol/li[1]/div[2]/form/div/div[8]/div/input"));
    ...
    public WebElement getInputForPhoneNumber(WebDriver driver) {
        phoneNumber = driver.findElement(
                By.xpath(
                        "/html/body/div[3]/main/div/div/div/div[4]/ol/li[1]/div[2]/form/div/div[9]/div/input"));
    ...
    public WebElement getNextButton(WebDriver driver) {
        next = driver.findElement(
                By.xpath(
                        "/html/body/div[3]/main/div/div/div/div[4]/ol/li[2]/div/div[3]/form/div[3]/div/button"));
